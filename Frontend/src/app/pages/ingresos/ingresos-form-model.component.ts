...
@Component({
  selector: 'app-ingresos-form-model',
  standalone: true,
  templateUrl: './ingresos-form-model.component.html',
...
export class IngresosFormModelComponent extends BaseDocumentForm {
  ...
  @Input() tipoOperacionOptions: Option[] = [];
  @Input() documentoReferenciaOptions: Option[] = [];
  @Input() selected: any;
  ...
  selectProductos(productos: Productos) {
    this.state.selected = {
      ...this.state.selected,
